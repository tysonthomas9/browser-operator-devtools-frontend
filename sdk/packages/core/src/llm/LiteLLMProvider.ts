...
export class LiteLLMProvider extends BaseLLMProvider {
  override name = 'litellm' as const;

  private static readonly DEFAULT_ENDPOINT = 'http://localhost:4000/v1/chat/completions';

  constructor(apiKey: string, endpoint?: string) {
    super(apiKey, endpoint || LiteLLMProvider.DEFAULT_ENDPOINT);
  }
